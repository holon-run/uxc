...
2. Inspect operation schema first:
   - `alchemy-openapi-cli post:/tokens/by-symbol -h`
...
3. Start with narrow single-asset reads before batch historical requests:
   - `alchemy-openapi-cli post:/tokens/by-symbol '{"symbols":["ETH"],"currency":"USD"}'`
...
4. Execute with positional JSON:
