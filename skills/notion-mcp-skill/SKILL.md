...
1. Login with OAuth authorization code flow (dynamic client registration first):
...
4. Prefer read path first:
   - Search/fetch current state before any write.
5. Execute writes only after explicit user confirmation:
